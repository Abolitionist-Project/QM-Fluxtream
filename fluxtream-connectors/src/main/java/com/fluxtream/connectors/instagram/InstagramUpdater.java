...
@Component
@Updater(prettyName = "Instagram", value = 14, objectTypes = { InstagramPhotoFacet.class }, extractor = InstagramFacetExtractor.class)
public class InstagramUpdater extends AbstractUpdater {
	...
	public void updateConnectorDataHistory(UpdateInfo updateInfo) throws Exception {
		...
		String feedUrl = "https://api.instagram.com/v1/users/self/feed?access_token=" + accessToken;
