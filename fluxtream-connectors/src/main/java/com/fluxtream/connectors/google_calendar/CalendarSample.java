...
public class CalendarSample {
	...
	// clientSecrets,
	// Collections.singleton(CalendarScopes.CALENDAR)).setCredentialStore(credentialStore)
	// .build();
	// // authorize
	...
	// client = new
	// com.google.api.services.calendar.Calendar.Builder(HTTP_TRANSPORT,
	...
	// }
	//
	// private static Calendar updateCalendar(Calendar calendar) throws
	// IOException {
