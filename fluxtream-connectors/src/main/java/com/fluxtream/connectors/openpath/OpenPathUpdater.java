...
@Component
@Updater(prettyName = "OpenPath", value = 89, objectTypes = {}, hasFacets = true)
public class OpenPathUpdater extends AbstractUpdater {
	...
	public boolean testConnection(long guestId, String accessKey, String secretKey) throws RateLimitReachedException {
		try {
			String restResponse = twoLeggedOAuthHelper.makeRestCall(connector, guestId, accessKey, secretKey, null, -1,
