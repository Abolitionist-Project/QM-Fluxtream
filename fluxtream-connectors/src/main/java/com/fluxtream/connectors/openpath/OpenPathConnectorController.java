...
public class OpenPathConnectorController {
	...
	public ModelAndView signin(HttpServletRequest request) {
		ModelAndView mav = new ModelAndView("connectors/openpath/enterCredentials");
		return mav;
	}

	@RequestMapping("/check")
	public ModelAndView check(@RequestParam("accessKey") String accessKey, @RequestParam("secretKey") String secretKey,
		...
		if (worked) {
			guestService.setApiKeyAttribute(guestId, Connector.getConnector("openpath"), "accessKey", accessKey);
			guestService.setApiKeyAttribute(guestId, Connector.getConnector("openpath"), "secretKey", secretKey);
