...
public class MymeeObservationFieldHandler implements FieldHandler {
	...
	//
	// Standard marshalling of facets to datastore assumes fixed channel name,
	// which
	...
	public void handleField(final long guestId, AbstractFacet facet) {
		...
		bodyTrackHelper.uploadToBodyTrack(guestId, "Mymee",
				Arrays.asList(observationName, observationName + "._comment"), data);
	}
}
