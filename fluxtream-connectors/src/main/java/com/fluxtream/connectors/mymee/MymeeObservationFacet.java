...
public class MymeeObservationFacet extends AbstractFacet {
	...
	// User-friendly name of Mymee "topic" -- the name of the Mymee button used
	// to make the observation.
	// See getChannelName for the datastore/URL version of this (datastore puts
	// each topic in a different channel)
	// NotNull
	public String name;
	...
	public String getChannelName() {
		// Datastore channel names have all characters that aren't alphanumeric
		// or underscores replaced with underscores
