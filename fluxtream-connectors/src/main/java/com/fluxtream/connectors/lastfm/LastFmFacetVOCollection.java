...
public class LastFmFacetVOCollection extends AbstractFacetVOCollection {
	...
	private void addLovedTrack(LastFmLovedTrackFacet facet, TimeInterval timeInterval, GuestSettings settings) {
		if (lovedTracks == null)
			lovedTracks = new ArrayList<LastFmLovedTrackFacetVO>();
	...
	private void addRecentTrack(LastFmRecentTrackFacet facet, TimeInterval timeInterval, GuestSettings settings) {
		if (recentTracks == null)
			recentTracks = new ArrayList<LastFmRecentTrackFacetVO>();
