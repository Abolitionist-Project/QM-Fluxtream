...
public class WithingsBodyScaleMeasureFacetVO extends AbstractInstantFacetVO<WithingsBodyScaleMeasureFacet> implements
		Serializable {
	...
	@Override
	public void fromFacet(WithingsBodyScaleMeasureFacet facet, TimeInterval timeInterval, GuestSettings settings) {
		long elapsed = timeInterval.start - TimeUtils.fromMidnight(facet.measureTime, timeInterval.timeZone);
		...
		this.description = weight + " " + unitLabel;
	}
