...
public class KhanAcademyOAuthController {
	...
	public String getToken(HttpServletRequest request, HttpServletResponse response) throws IOException,
		...
		String oauthCallback = env.get("homeBaseUrl") + "khanacademy/upgradeToken";
		...
		OAuthProvider provider = new CommonsHttpOAuthProvider("http://www.khanacademy.org/api/auth/request_token",
				"http://www.khanacademy.org/api/auth/access_token", "http://www.khanacademy.org/api/auth/authorize");
	...
	public String upgradeToken(HttpServletRequest request, HttpServletResponse response) throws OAuthException,
		...
		guestService.setApiKeyAttribute(guest.getId(), Connector.getConnector("khanacademy"), "accessToken",
				consumer.getToken());
		guestService.setApiKeyAttribute(guest.getId(), Connector.getConnector("khanacademy"), "tokenSecret",
				consumer.getTokenSecret());

		return "redirect:/analyze/from/" + Connector.getConnector("khanacademy").getName();
	}
