...
public class NikePlusConnectorController {
	...
	public ModelAndView check(@RequestParam("username") String username, HttpServletRequest request)
		...
		// catch (Exception e) {}
		if (worked) {
			guestService.setApiKeyAttribute(guestId, Connector.getConnector("nikeplus"), "username", username);
			return mav;
		} else {
