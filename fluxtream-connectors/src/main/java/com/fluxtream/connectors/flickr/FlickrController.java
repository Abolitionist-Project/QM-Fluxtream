...
public class FlickrController {
	...
	public String getToken(HttpServletRequest request, HttpServletResponse response) throws NoSuchAlgorithmException {
		...
		String loginUrl = "http://flickr.com/services/auth/" + "?api_key=" + api_key + "&perms=read&api_sig=" + api_sig;
	...
	public String upgradeToken(HttpServletRequest request, HttpServletResponse response)
		...
		String getTokenUrl = "http://api.flickr.com/services/rest/" + "?method=flickr.auth.getToken&api_key=" + api_key
				+ "&frob=" + frob + "&api_sig=" + api_sig;
		...
		return "redirect:/analyze/from/" + flickrConnector.getName();
	}
