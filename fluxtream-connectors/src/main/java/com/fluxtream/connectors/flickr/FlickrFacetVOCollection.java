...
public class FlickrFacetVOCollection extends AbstractFacetVOCollection<FlickrPhotoFacet> implements ImageVOCollection {

	List<FlickrPhotoFacetVO> photos;

	@Override
	public void extractFacets(List<FlickrPhotoFacet> facets, TimeInterval timeInterval, GuestSettings settings) {
		if (facets.size() == 0)
			return;
