...
public final class DatabaseViewUtil {
  ...
  private DatabaseViewUtil() { throw new UnsupportedOperationException("Utility classes cannot be constructed."); }
  
  public static final StringBuilder appendInfo(final StringBuilder stringBuilder, final DatabaseView database) {
    try { appendInfo((Appendable) stringBuilder, database); } catch (final IOException e) {}
    return stringBuilder;
  }
  
  public static final StringBuffer appendInfo(final StringBuffer stringBuffer, final DatabaseView database) {
    try { appendInfo((Appendable) stringBuffer, database); } catch (final IOException e) {}
    return stringBuffer;
  }
