...
public final class TableUtil {
  ...
  private TableUtil() { throw new UnsupportedOperationException("Utility classes cannot be constructed."); }
  ...
  public static final String getFieldClassName(final Table table, final int field) {
    if ((field < 0) || (field >= table.getFieldCount())) throw new ArrayIndexOutOfBoundsException("Field number "  + field  + " doesn't exist.");
    ...
    for (int record = 0; record < recordCount; record++) {
      ...
      if (data != null) {
        ...
        if (thisClass.startsWith("java.lang.")) thisClass = thisClass.substring(10);
  ...
  public static final StringBuilder appendInfo(final StringBuilder stringBuilder, final Table table) {
    try { appendInfo((Appendable) stringBuilder, table); } catch (final IOException e) {}
    return stringBuilder;
  }
  
  public static final StringBuffer appendInfo(final StringBuffer stringBuffer, final Table table) {
    try { appendInfo((Appendable) stringBuffer, table); } catch (final IOException e) {}
    return stringBuffer;
  }
