...
public class HashUtilsTest {
	...
	public void testComputeSha256Hash() {
		try {
			...
			Assert.fail("Call to FluxtreamCapturePhotoFacet.testComputeSha256Hash() threw a NoSuchAlgorithmException: "
					+ e);
		}
	}
	...
	public void testComputeMd5Hash() {
		try {
			...
			Assert.fail("Call to FluxtreamCapturePhotoFacet.testComputeMd5Hash() threw a NoSuchAlgorithmException: "
					+ e);
		}
	}
}
