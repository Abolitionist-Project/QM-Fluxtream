...
public class Uglify {
	...
	public static void main(String[] args) {
		try {
			...
			JavaScriptCompressor compressor = new JavaScriptCompressor(new StringReader(js),
	...
	static class YuiCompressorErrorReporter implements ErrorReporter {
		...
		public EvaluatorException runtimeError(String message, String sourceName, int line, String lineSource,
				int lineOffset) {
			return new EvaluatorException(message + ":line=" + line + ":lineSource=" + lineSource + ":lineOffset="
					+ lineOffset);
		}
	}
}
