...
public class RequestUtils {
	/**
	 * NOTE(candu): This also works for /etc/hosts overrides, and it correctly
	 * distinguishes requests over 10.x.x.x, 192.168.x.x, etc. from localhost
	 * requests.
	 * 
	 * @param request
	...
	/**
	 * NOTE(candu): Currently this just wraps isLocal(), but it could be used to
	 * identify other test/development environments.
	 * 
	 * @param request
	 *            the incoming HTTP request
