...
public class WWOHelper {
	...
	public void setWeatherInfo(DayMetadataFacet info, List<WeatherInfo> weatherInfo) {
	...
	public List<WeatherInfo> getWeatherInfo(double latitude, double longitude, String fdate) throws HttpException,
			IOException {
		String wwoUrl = "http://www.worldweatheronline.com/feed/premium-weather-v2.ashx?" + "key=" + env.get("wwo.key")
				+ "&feedkey=" + env.get("wwo.feedkey") + "&format=json&q=" + latitude + "," + longitude + "&date="
				+ fdate;
