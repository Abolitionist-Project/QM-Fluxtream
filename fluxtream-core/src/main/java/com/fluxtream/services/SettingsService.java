...
public interface SettingsService {
	...
	public GuestAddress addAddress(long guestId, String type, String address, double latitude, double longitude,
			long since, long until, double radius, String jsonString);

	public GuestAddress addAddress(long guestId, String type, String address, double latitude, double longitude,
			long since, double radius, String jsonString);
