...
public class TwoLeggedOAuthHelper extends ApiClientSupport {
	...
	public final String makeRestCall(Connector connector, long guestId, String accessToken, String tokenSecret,
			Map<String, String> additionalParameters, int objectTypes, String urlString)
		...
		try {
			...
			OAuthConsumer consumer = new DefaultOAuthConsumer(accessToken, tokenSecret);
