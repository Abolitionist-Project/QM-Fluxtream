...
public class ObjectType {
	...
	/**
	 * "Custom" objectTypes are there to compute a value (hashCode()) for
	 * special API calls. We use it for counting those calls so we don't confuse
	 * them with the usual API calls that retrieve data.
	 * 
	 * @param name
	 */
