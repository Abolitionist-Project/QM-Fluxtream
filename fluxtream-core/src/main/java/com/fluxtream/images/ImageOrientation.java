...
/**
 * An enum for recording image orientation and what operation(s) needs to be
 * applied in order to transform it. There are eight possible orientations,
 * shown here (taken from http://sylvana.net/jpegcrop/exif_orientation.html):
 * 
 * <pre>
 *     1        2       3      4         5            6           7          8
 * 
...
public enum ImageOrientation {
	...
	ORIENTATION_1(1, null, null), ORIENTATION_2(2, null, Scalr.Rotation.FLIP_HORZ), ORIENTATION_3(3,
			Scalr.Rotation.CW_180, null), ORIENTATION_4(4, null, Scalr.Rotation.FLIP_VERT), ORIENTATION_5(5,
			Scalr.Rotation.CW_90, Scalr.Rotation.FLIP_HORZ), ORIENTATION_6(6, Scalr.Rotation.CW_90, null), ORIENTATION_7(
			7, Scalr.Rotation.CW_270, Scalr.Rotation.FLIP_HORZ), ORIENTATION_8(8, Scalr.Rotation.CW_270, null);
	...
	/**
	 * Tries to read the EXIF orientation data in the image in the
	 * {@link InputStream}. Returns <code>null</code> if not found or if an
	 * error occurs.
	 */
	@Nullable
	 ...
	 * Returns <code>null</code> if not found or if an error occurs.
	 */
	@Nullable
