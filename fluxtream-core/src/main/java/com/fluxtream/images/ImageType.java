...
/**
 * <p>
 * <code>ImageType</code> is an enum representing the various types of supported
 * images.
 * </p>
 * 
...
public enum ImageType {
	...
	static {
		...
		final Map<String, ImageType> imageTypeByFileExtension = new HashMap<String, ImageType>(
				ImageType.values().length);
	...
	ImageType(@NotNull final String mediaType, @NotNull final String fileExtension,
			@NotNull final String imageReaderFormatName) {
