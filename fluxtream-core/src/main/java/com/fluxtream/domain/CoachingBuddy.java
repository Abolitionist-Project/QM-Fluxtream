...
@NamedQueries({
		@NamedQuery(name = "coachingBuddies.byGuestId", query = "SELECT buddy FROM CoachingBuddies buddy WHERE buddy.guestId=?"),
		@NamedQuery(name = "coachingBuddies.byBuddyId", query = "SELECT buddy FROM CoachingBuddies buddy WHERE buddy.buddyId=?"),
		@NamedQuery(name = "coachingBuddies.byGuestAndBuddyId", query = "SELECT buddy FROM CoachingBuddies buddy WHERE buddy.guestId=? AND buddy.buddyId=?"),
		@NamedQuery(name = "coachingBuddies.delete.all", query = "DELETE FROM CoachingBuddies buddy WHERE buddy.guestId=?") })
