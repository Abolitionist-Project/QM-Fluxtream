...
public class NotificationsStore {
	...
	@Secured("ROLE_ADMIN")
	public String addNotification(@PathParam("username") String username, @FormParam("message") String message,
	...
	@Path("/{id}")
	@Produces({ MediaType.APPLICATION_JSON })
	public String discardNotification(@PathParam("id") String idString) throws IOException {
	...
	@DELETE
	@Produces({ MediaType.APPLICATION_JSON })
	public String discardNotifications(@QueryParam("ids") String ids) throws IOException {
