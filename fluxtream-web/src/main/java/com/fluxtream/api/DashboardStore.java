...
public class DashboardStore {
	...
	public String getDashboards() {
		...
		try {
			...
			StringBuilder sb = new StringBuilder("module=API component=dashboardStore action=getDashboards").append(
					" guestId=").append(guestId);
	...
	private JSONObject toJSONObject(final long guestId, final Dashboard dashboard, final DashboardWidget dashboardWidget) {
	...
	public String addDashboard(@FormParam("dashboardName") String dashboardName) throws UnsupportedEncodingException {
		...
		try {
			...
			StringBuilder sb = new StringBuilder("module=API component=dashboardStore action=addDashboard").append(
					" guestId=").append(guestId);
			logger.info(sb.toString());
			return getDashboards();
		} catch (Exception e) {
			StringBuilder sb = new StringBuilder("module=API component=dashboardStore action=addDashboard")
					.append(" guestId=").append(guestId).append(" stackTrace=<![CDATA[").append(Utils.stackTrace(e))
					.append("]]>");
	...
	public String removeDashboard(@PathParam("dashboardId") long dashboardId) throws UnsupportedEncodingException {
		...
		try {
			...
			StringBuilder sb = new StringBuilder("module=API component=dashboardStore action=deleteDashboard").append(
					" guestId=").append(guestId);
			logger.info(sb.toString());
			return getDashboards();
		} catch (Exception e) {
	...
	@Produces({ MediaType.APPLICATION_JSON })
	public String renameDashboard(@PathParam("dashboardId") long dashboardId, @QueryParam("name") String newName)
			throws UnsupportedEncodingException {
		long guestId = AuthHelper.getGuestId();
		try {
			newName = URLDecoder.decode(newName, "UTF-8");
			dashboardsService.renameDashboard(guestId, dashboardId, newName);
			StringBuilder sb = new StringBuilder("module=API component=dashboardStore action=renameDashboard").append(
					" guestId=").append(guestId);
			logger.info(sb.toString());
			return getDashboards();
		} catch (Exception e) {
	...
	@Produces({ MediaType.APPLICATION_JSON })
	public String setActiveDashboard(@PathParam("dashboardId") long dashboardId) throws UnsupportedEncodingException {
		long guestId = AuthHelper.getGuestId();
		try {
	...
	@Produces({ MediaType.APPLICATION_JSON })
	public String addWidget(@PathParam("dashboardId") long dashboardId, @FormParam("widget") String widgetJson)
			throws UnsupportedEncodingException {
		long guestId = AuthHelper.getGuestId();
		try {
			widgetJson = URLDecoder.decode(widgetJson, "UTF-8");
			dashboardsService.addWidget(guestId, dashboardId, widgetJson);
			StringBuilder sb = new StringBuilder("module=API component=dashboardStore action=addWidget").append(
					" guestId=").append(guestId);
			logger.info(sb.toString());
			return getDashboards();
		} catch (Exception e) {
	...
	@Produces({ MediaType.APPLICATION_JSON })
	public String removeWidget(@PathParam("dashboardId") long dashboardId, @PathParam("widgetName") String widgetName)
			throws UnsupportedEncodingException {
		long guestId = AuthHelper.getGuestId();
		try {
			widgetName = URLDecoder.decode(widgetName, "UTF-8");
			dashboardsService.removeWidget(guestId, dashboardId, widgetName);
			StringBuilder sb = new StringBuilder("module=API component=dashboardStore action=removeWidget").append(
					" guestId=").append(guestId);
			logger.info(sb.toString());
			return getDashboards();
		} catch (Exception e) {
	...
	public String setWidgetsOrder(@PathParam("dashboardId") long dashboardId,
		...
		try {
			...
			StringBuilder sb = new StringBuilder("module=API component=dashboardStore action=setWidgetOrder").append(
					" guestId=").append(guestId);
			logger.info(sb.toString());
			return getDashboards();
		} catch (Exception e) {
	...
	@Path("/reorder")
	@Produces({ MediaType.APPLICATION_JSON })
	public String setDashboardsOrder(@FormParam("dashboardIds") String dashboardIds)
			throws UnsupportedEncodingException {
		long guestId = AuthHelper.getGuestId();
		try {
	...
	public String saveWidgetSettings(@PathParam("dashboardId") long dashboardId,
			@PathParam("widgetName") String widgetName, @FormParam("settingsJSON") String settingsJSON)
			throws UnsupportedEncodingException {
		long guestId = AuthHelper.getGuestId();
		try {
			widgetName = URLDecoder.decode(widgetName, "UTF-8");
