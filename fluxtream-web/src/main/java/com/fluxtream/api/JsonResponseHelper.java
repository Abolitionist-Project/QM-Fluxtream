...
/**
 * <p>
 * <code>JsonResponseHelper</code> helps create JSON {@link Response}s. The
 * response body consists of a JSON representation of an appropriate
 * {@link StatusModel}.
 * </p>
 * 
...
public final class JsonResponseHelper {
	...
	/**
	 * Creates a {@link Response} with an HTTP 200 OK status code and a JSON
	 * body consisting of a success {@link StatusModel} containing the given
	 * <code>message</code>.
	 * 
	 ...
	 * Creates a {@link Response} with an HTTP 200 OK status code and a JSON
	 * body consisting of a success {@link StatusModel} containing the given
	 * <code>message</code> and <code>payload</code>.
	 * 
	...
	/**
	 * Creates a {@link Response} with an HTTP 400 Bad Request status code and a
	 * JSON body consisting of a failure {@link StatusModel} containing the
	...
	/**
	 * Creates a {@link Response} with an HTTP 404 Not Found status code and a
	 * JSON body consisting of a failure {@link StatusModel} containing the
	 * given <code>message</code>.
	 * 
	 * @see StatusModel#failure(String)
	...
	/**
	 * Creates a {@link Response} with an HTTP 403 Forbidden status code and a
	 * JSON body consisting of a failure {@link StatusModel} containing the
	 * given <code>message</code>.
	 * 
	 * @see StatusModel#failure(String)
	...
	/**
	 * Creates a {@link Response} with an HTTP 415 Unsupported Media Type status
	 * code and a JSON body consisting of a failure {@link StatusModel}
	 * containing the given <code>message</code>.
	 * 
	 * @see StatusModel#failure(String)
	 */
	@NotNull
	...
	/**
	 * Creates a {@link Response} with an HTTP 500 Internal Server Error status
	 * code and a JSON body consisting of a failure {@link StatusModel}
	 * containing the given <code>message</code>.
	 * 
	 * @see StatusModel#failure(String)
